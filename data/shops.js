window.ShopsData = {
  ...
  rotations: [
    ...
    { shop: 'arena',  version: '2.0', st: 'Arcus',        lv8: ['Poke Mod', 'Mitigation Mod', 'Vigilant Mod', 'Safeguard Mod'],           lv4: ['Missile Mod', 'Crit Rate Mod', 'Pile Bunker Mod', 'Anti-AoE Mod'] },
    { shop: 'border', version: '2.1', st: 'Eye Of Faith', lv8: ['Urgent Repair Mod', 'Retaliation Mod', 'Adaptive Mod', 'Breaker Mod'],   lv4: ['Tending Mod', 'DMG Taken Mod', 'Armor Mod', 'HP Mod'] },
    ...
    { shop: 'arena',  version: '2.6', st: 'Kong',         lv8: ['Poke Mod', 'Mitigation Mod', 'Vigilant Mod', 'Safeguard Mod'],           lv4: ['Missile Mod', 'Crit Rate Mod', 'Pile Bunker Mod', 'Anti-AoE Mod'] },
