window.GlossaryData = {
  "buf": {
    ...
    "900003": {
      "name": "Guts",
      "effect": "When a part would receive damage that reduces its HP to 0, lock it at 1 HP instead."
    },
    "900004": {
      "name": "Re-ATK",
    ...
    "900005": {
      "name": "Re-Act",
      "effect": "After the current action ends, take another action using the remaining or full movement distance."
    },
    "900006": {
    ...
    "900018": {
      "name": "Passive Repair",
      "effect": "Automatically repair a part's HP when specific conditions are met or at the end of an action."
    },
    "900019": {
      "name": "Link Repair",
    ...
    "900027": {
      "name": "Target Shift",
      "effect": "Redirect incoming attacks to a different target or location."
    },
    "900028": {
      "name": "Add Strike",
    ...
    "900101": {
      "name": "Execute",
      "effect": "A finishing blow that directly destroys a critically damaged part."
    },
    "900109": {
      "name": "Execute",
      "effect": "A finishing blow that directly destroys a critically damaged part."
    ...
    "1015414": {
      "name": "Critical Sense",
      "effect": "Heightened awareness that increases critical hit rate or damage."
    },
    "1013503": {
    ...
    "3004502": {
      "name": "Stealth I",
      "effect": "Reduces enemy targeting priority by 5%; enemies are less likely to select this unit as their primary target."
    },
    "3005412": {
    ...
    "7100901": {
      "name": "Movement UP",
      "effect": "Increases movement range."
    },
    "7101003": {
