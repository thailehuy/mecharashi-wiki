#!/usr/bin/env node
// Scrapes backpack detail data from the CN API for every backpack in list-cn.json.
// Run with: node scrape-detail.js
...
const OUT_PATH   = path.join(__dirname, 'detail-cn.json');
const BASE_URL  = 'https://ma-activity.zlongame.com/common/infodata/mQuery.do';
const PARAMS    = 'appkey=1616148215678&target=backpack_data&type=detail';
